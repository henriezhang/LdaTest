...
public class InitModelTool implements GenericTool {
  ...
  public void initModel(
    ...
    /*  envConf.addResource(new Path("/data/tdwadmin/tdwenv/tdwgaia/etc/hadoop/core-site.xml"));
      envConf.addResource(new Path("/data/tdwadmin/tdwenv/tdwgaia/etc/hadoop/hdfs-site.xml"));
      envConf.addResource(new Path("/data/tdwadmin/tdwenv/tdwgaia/etc/hadoop/mapred-site.xml"));
      envConf.addResource(new Path("/data/tdwadmin/tdwenv/tdwgaia/etc/hadoop/yarn-site.xml"));*/
